        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="content">
                    ...
                    <form name="myForm" action="<?php echo base_url(); ?>index.php/control/new_store_register" method="post" id="store-reg" enctype="multipart/form-data">
                                                ...
                                                <fieldset>
                                                    <div class="form-group">
                                                        <div class="row">
                                                          ...
                                                          <img id="preview" src="<?php echo base_url().'assets/images/upload.png';  ?>" alt="your image" height="150" width="220" />
                                                          <input type="file" name="files" id="fileUploader" required="">
                                                    ...
                                                    <div class='form-group'>
                                                        <div class='row'>
                                                            <div class="col-md-12 col-md-offset-0">
                                                                ...
                                                                <input type="text" placeholder="Business Name" class="form-control" style="border-radius:15px;" name="business_name" id="busi_name" value="<?php echo set_value('business_name'); ?>" required>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="email" name="email"  placeholder="Enter Email Address" class="form-control" id="email" value="<?php echo set_value('email') ;?>" required>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="password" minlength="6" maxlength="12" name="password" placeholder="Password" value="<?php echo set_value('password'); ?>" class="form-control" id="pass_value" required >
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="password" minlength="6" maxlength="12" name="confirmpassword" placeholder="Confirm Password" class="form-control" value="<?php echo set_value('confirmpassword'); ?>" id="cpass_value" required >
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" minlength="10" maxlength="10" name="phone" placeholder="Enter Mobile number" class="form-control" id="mobile_number" onkeypress="return isNumber(event)" value="<?php echo set_value('phone'); ?>" required>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" name="address1" class="form-control myadd" placeholder="Address Line-1" value="<?php echo set_value('address1'); ?>" id="us2-address" required>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-feedback multi-select-full">
                                                                ...
                                                                <div class="multi-select-full">
                                                                    ...
                                                                    <select name="state" id="state" class="select_style" value="<?php echo set_value('state'); ?>" required>
                                                    ...
                                                    <div class='row'>
                                                        ...
                                                        <div class="col-md-6" >
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" name="city" class="form-control" placeholder="City" id="city" value="<?php echo set_value('city'); ?>" required>
                                                                <div class="form-control-feedback" style="top:30px;">
                                                                    <i class="icon-home8 text-muted"></i>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" name="zipcode" class="form-control" minlength="3" maxlength="6" onkeypress="return isNumber(event)" id="zipcode" placeholder="Zip Code" value="<?php echo set_value('zipcode'); ?>" required>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" name="latitude"  class="form-control" placeholder="Latitude" value="22.7195687"  id="us2-lat" readonly="readonly" required>
                                                                <div class="form-control-feedback" style="top:30px;">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" name="longitude" class="form-control" placeholder="Longitude" value="75.8577258"  id="us2-lon" readonly="readonly" required>
                                                                <div class="form-control-feedback" style="top:30px;">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group" style="margin-top: -20px;">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <!--shesh_Code Sart *-->
                                                                <textarea name="description" id="des_value" class="form-control" placeholder="Your Store Description" style="max-height: 62px; max-width: 797px;" required><?php echo set_value('description'); ?></textarea>
