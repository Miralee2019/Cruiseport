...
<body>
  ...
  <form action="<?php echo base_url(); ?>index.php/control/addOffer" enctype="multipart/form-data" method="post" id="offer-add">
                                                ...
                                                <div class="">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12 filter food">
                                                            <div class="row">
                                                                    <?php 
                                            $all_images=$this->Adminmodel->all_image_list('food');
                                                                    foreach($all_images as $image){ ?>
                                                                <div class="col-md-3">
                                                                    <div>
                                                                        <a href="#" class="custom-close3">
                                                                            <img class="temp_img" src="<?php echo base_url()."image_library/".$image->image_name; ?>" />
                                                        ...
                                                        <div class="col-lg-12 filter lifestyle">
                                                            <div class="row">
                                                                <?php 
                                            $all_images=$this->Adminmodel->all_image_list('lifestyle');
                                                                    foreach($all_images as $image){ ?>
                                                                <div class="col-md-3">
                                                                    <div>
                                                                        <a href="#" class="custom-close3">
                                                        ...
                                                        <div class="col-lg-12 filter electronics">
                                                            <?php 
                                            $all_images=$this->Adminmodel->all_image_list('electronics');
                                                                    foreach($all_images as $image){ ?>
                                                                <div class="col-md-3">
                                                                    <div>
                                                                        <a href="#" class="custom-close3">
                                                        ...
                                                        <div class="col-lg-12 filter entertainment">
                                                            <?php 
                                            $all_images=$this->Adminmodel->all_image_list('entertainment');
                                                                    foreach($all_images as $image){ ?>
                                                                <div class="col-md-3">
                                                                    <div>
                                                                        <a href="#" class="custom-close3">
                                                        ...
                                                        <div class="col-lg-12 filter drinks">
                                                             <?php 
                                            $all_images=$this->Adminmodel->all_image_list('drinks');
                                                                    foreach($all_images as $image){ ?>
                                                                <div class="col-md-3">
                                                                    <div>
                                                                        <a href="#" class="custom-close3">
                                                        ...
                                                        <div class="col-lg-12 filter health">
                                                             <?php 
                                            $all_images=$this->Adminmodel->all_image_list('health');
                                                                    foreach($all_images as $image){ ?>
                                                                <div class="col-md-3">
                                                                    <div>
                                                                        <a href="#" class="custom-close3">
                                                        ...
                                                        <div class="col-lg-12 filter fitness">
                                                           <?php 
                                            $all_images=$this->Adminmodel->all_image_list('fitness');
                                                                    foreach($all_images as $image){ ?>
                                                                <div class="col-md-3">
                                                                    <div>
                                                                        <a href="#" class="custom-close3">
                                                        ...
                                                        <div class="col-lg-12 filter home">
                                                           <?php 
                                            $all_images=$this->Adminmodel->all_image_list('home');
                                                                    foreach($all_images as $image){ ?>
                                                                <div class="col-md-3">
                                                                    <div>
                                                                        <a href="#" class="custom-close3">
                                                        ...
                                                        <div class="col-lg-12 filter auto">
                                                              <?php 
                                            $all_images=$this->Adminmodel->all_image_list('auto');
                                                                    foreach($all_images as $image){ ?>
                                                                <div class="col-md-3">
                                                                    <div>
                                                                        <a href="#" class="custom-close3">
                                                        ...
                                                        <div class="col-lg-12 filter travel">
                                                             <?php 
                                            $all_images=$this->Adminmodel->all_image_list('travel');
                                                                    foreach($all_images as $image){ ?>
                                                                <div class="col-md-3">
                                                                    <div>
                                                                        <a href="#" class="custom-close3">
                                                        ...
                                                        <div class="col-lg-12 filter beauty">
                                                             <?php 
                                            $all_images=$this->Adminmodel->all_image_list('beauty');
                                                                    foreach($all_images as $image){ ?>
                                                                <div class="col-md-3">
                                                                    <div>
                                                                        <a href="#" class="custom-close3">
                                                        ...
                                                        <div class="col-lg-12 filter shopping">
                                                           <?php 
                                            $all_images=$this->Adminmodel->all_image_list('shopping');
                                                                    foreach($all_images as $image){ ?>
                                                                <div class="col-md-3">
                                                                    <div>
                                                                        <a href="#" class="custom-close3">
                                                        ...
                                                        <div class="col-lg-12 filter education">
                                                             <?php 
                                            $all_images=$this->Adminmodel->all_image_list('education');
                                                                    foreach($all_images as $image){ ?>
                                                                <div class="col-md-3">
                                                                    <div>
                                                                        <a href="#" class="custom-close3">
                                                        ...
                                                        <div class="col-lg-12 filter outdoors">
                                                          <?php 
                                            $all_images=$this->Adminmodel->all_image_list('outdoors');
                                                                    foreach($all_images as $image){ ?>
                                                                <div class="col-md-3">
                                                                    <div>
                                                                        <a href="#" class="custom-close3">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <label for="dtp_input1" class="control-label"><!-- Expiry Date -->Validate Till</label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <label id="points1-error" class="error" for="points1" style="display: inline-block;"></label>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <label id="points2-error" class="error" for="points2"></label>
