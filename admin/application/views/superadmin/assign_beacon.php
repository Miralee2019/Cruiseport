...
<li><?php echo $name; ?></li>
	...
	<form action="<?php echo  base_url('index.php/superadmin/assign_beacon_confirm'); ?>" method="post">
	<div class="form-group">
		<div class="col-md-6">
...
foreach($beacon_id as $value)
{
  echo '<input type="hidden" name="beacon_id[]" value="'. $value. '">';
		...
		?>
		<!-- 	<input type="hidden" name="beacon_id" value="<?php // print_r(serialize($beacon_id)); ?>"> -->
...
<div class="col-md-12">
<div class="form-group">
	<button type="submit" class="btn btn-success btn-lg" style="margin-top: 20px;">Assign</button>
</div>
</div>
</form>
	</div>
