		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<div class="content pb-20">
					...
					<form action="<?php echo base_url(); ?>index.php/superadmin/check_login" method="post" class="form-validate" name="myForm" >
						<div class="panel panel-body login-form">
								...
								<div id="hidemenow">
											...
											<?php
												...
												if ($this->session->flashdata()) {
													echo $this->session->flashdata('login_display_password_change');
												}
											
											?>

								</div>
								<p style="color: red;"><?php echo $this->session->flashdata('superlogin_error'); ?><p>
							</div>
							...
							<div class="form-group has-feedback has-feedback-left">
								<input type="password" class="form-control" placeholder="Password" minlength="6" maxlength="12" name="password" 
								value="<?php echo set_value('password') ; ?>">
								

								<h7 style="color: red;float: left;" ><?php echo form_error('password'); ?></h7>

								 <?php if(form_error('username') && form_error('username')) { ?>
                                    <div class="form-control-feedback" style="top: 20px;">
                                        <i class="icon-lock2 text-muted"></i>
                                    </div>
                                <?php } elseif(form_error('username')) { ?>
							...
							<div class="form-group login-options">
								<div class="row">
									...
									<div class="col-sm-6 text-right">
										<a href="<?php echo base_url(); ?>index.php/superadmin/forgot_password">Forgot password?</a>
									</div>
								</div>
							</div>

							<div class="form-group">
								<button type="submit" style="background-color: #01a8f6;color: white;" class="btn btn-block">Login <i class="icon-arrow-right14 position-right"></i></button>
							</div>
