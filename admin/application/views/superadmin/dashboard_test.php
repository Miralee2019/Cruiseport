                    ...
                    <div class="row">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-lg-8 col-xs-8" style="margin-top: -10px;" >
                                        <div class="col-md-12 col-xs-12" style="margin-top: -8px;">
                                            ...
                                            $query=$this->db->query('SELECT sum(no_of_rubs) as total FROM `payment_details` where status="authorized"');
                                            $eran_money=$query->row();

                                            if(!empty($eran_money))
                                            {
                                                echo round($eran_money->total,2);
                                            }
                                            ?> </b> </h1>	
                                        </div>
                                        <div class="col-md-12 col-xs-12" style="margin-top:-10px;">
                                            <span style="margin-right: -10px;padding-right:0px;
                                            float:left;"><?php echo strtoupper('Total Earning') ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div id="today-revenue"></div>
                        ...
                        <div class="col-lg-3">
                            <div class="panel twitter">
                                <div class="panel-body">
                                    <div class="col-lg-4 col-xs-4">
                                        <i class="icon-cart-add twitter" style="font-size: 35px;"></i>
                                    </div>
                                    <div class="col-lg-8 col-xs-8" style="margin-top: -10px;" >
                                        <div class="col-md-12 col-xs-12" style="margin-top: -8px;">
                                            <h1 class="no-margin"> <b style="text-align: center;font-size: 30px;margin-left: 0px;"> <?php 
                                            $query=$this->db->query('SELECT sum(points) as total FROM `referral_app`');
                                            $reward_rubs=$query->row();

                                            if(!empty($reward_rubs))
                                            {
                                                echo $reward_rubs->total*2/4;
                                            }
                                            ?> </b> </h1>   
                                        </div>
                                        <div class="col-md-12 col-xs-12" style="margin-top:-10px;">
                                            <span style="margin-right: -10px;padding-right:0px;
                                            float:left;"><?php echo strtoupper('Total Reward') ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div id="today-revenue"></div>
                        ...
                        <div class="col-lg-3">
                            <div class="panel facebook">
                                <div class="panel-body">
                                    <div class="col-lg-4 col-xs-4">
                                        <i class="icon-cart-add facebook" style="font-size: 35px;"></i>
                                    </div>
                                    <div class="col-lg-8 col-xs-8" style="margin-top: -10px;" >
                                        <div class="col-md-12 col-xs-12" style="margin-top: -8px;">
                                            <h1 class="no-margin"> <b style="text-align: center;font-size: 30px;margin-left: 0px;"> <?php 
                                            $query=$this->db->query('SELECT sum(no_of_rubs) as total FROM `T_PaytmRedeemRequests` where request_status=10');
                                            $paytm_rubs=$query->row();

                                            if(!empty($paytm_rubs))
                                            {
                                                echo $paytm_rubs->total/4;
                                            }
                                            ?> </b> </h1>   
                                        </div>
                                        <div class="col-md-12 col-xs-12" style="margin-top:-10px;">
                                            <span style="margin-right: -10px;padding-right:0px;
                                            float:left;"><?php echo strtoupper('Total Paytm') ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div id="today-revenue"></div>
                         ...
                         <div class="col-lg-3">
                            <div class="panel walk">
                                <div class="panel-body">
                                    <div class="col-lg-4 col-xs-4">
                                        <i class="icon-cart-add walk" style="font-size: 35px;"></i>
                                    </div>
                                    <div class="col-lg-8 col-xs-8" style="margin-top: -10px;" >
                                        <div class="col-md-12 col-xs-12" style="margin-top: -8px;">
                                            <h1 class="no-margin"> <b style="text-align: center;font-size: 30px;margin-left: 0px;"> <?php 
                                            $query=$this->db->query('SELECT sum(amount) as total FROM `payment_details` where status="authorized"');
                                            $eran_money=$query->row();
                            ...
                            <div class="panel purchase">
                                <div class="panel-body">
                                    ...
                                    <div class="col-lg-8 col-xs-8" style="margin-top: -10px;" >
                                        <div class="col-md-12 col-xs-12" style="margin-top: -8px;">
                                            <h1 class="no-margin"> <b style="text-align: center;font-size: 30px;margin-left: 0px;"> <?php 
                                            $query=$this->db->query('SELECT sum(claim_for_rubs) as total FROM `T_CouponClaims` where request_status="10"');
                                            $coupon_money=$query->row();

                                            if(!empty($coupon_money))
                                            {
                                                echo round($coupon_money->total/4,2);
                                            }
                                            ?> </b> </h1>   
                                        </div>
                                        <div class="col-md-12 col-xs-12" style="margin-top:-10px;">
                                            <span style="margin-right: -10px;padding-right:0px;
                                            float:left;"><?php echo strtoupper('Total Coupon') ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div id="today-revenue"></div>
