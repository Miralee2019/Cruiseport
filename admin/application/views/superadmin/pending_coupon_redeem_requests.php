<?php error_reporting(0); ?>
                        ...
                        <table class="table table-hover" id="sample_3">
                                ...
                                <?php foreach ($requests as $key) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php if(empty($coupon[0]->coupon_id)){ ?>
                                                ...
                                                <li class="dropdown">
                                                    ...
                                                    <ul class = "dropdown-menu left" role = "menu">
                                                        ...
                                                        <?php if($key->request_status == 2) { ?>
                                                            ...
                                                            <li><a href="#" id="change_redeemstatus" data-claim = <?php echo $key->id; ?> data-user = <?php echo $key->user_id; ?> data-coupon = <?php echo $key->coupon_id; ?>  data-status = "10" ><i class="icon-check"></i> Accept </a></li>
                                                            <li>

                                                            <li><a href="#" id="change_redeemstatus" data-claim = <?php echo $key->id; ?> data-user = <?php echo $key->user_id;?> data-coupon = <?php echo $key->coupon_id; ?> data-status = "8" ><i class="icon-cross"></i> Reject </a></li>
                                                            <li>
    ...
    <script type="text/javascript">
        ...
        $('#shows').click(function() {
            ...
            window.location.href = "<?php echo base_url(); ?>index.php/superadmin/pending_couponRedeemRequests/chk";
