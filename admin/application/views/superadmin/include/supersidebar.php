...
<div class="sidebar sidebar-main">
						<div class="sidebar-content">
								...
								<div class="category-content no-padding">
									<ul class="navigation navigation-main navigation-accordion">
										...
										<li class="<?php if($url2 == 'superadmin/view_purchase' || $url2 == 'superadmin/dateRangePurchase'  ) echo 'active'; ?>">
											<a href="<?php echo base_url(); ?>index.php/superadmin/view_purchase"><i class=" icon-cart-add2"></i> <span>Store Request</span></a>
										</li>
										...
										<?php /*<li class="<?php if($url2 == 'superadmin/addCashrubBeacons') echo 'active'; ?>">
	                        ...
	                        <li class="<?php if($url2 == 'superadmin/addCashrubBeacons') echo 'active'; ?>">
											<a href="<?php echo base_url(); ?>index.php/superadmin/beacons">
											<i class=" icon-feed"></i> <span>Beacons</span></a>
										</li>
										<li class="<?php if($url2 == 'superadmin/redeemCoupon') echo 'active'; ?>">
											...
											<li class="<?php if($url2 == 'superadmin/billing') echo 'active'; ?>">
											<a href="<?php echo base_url(); ?>index.php/superadmin/billing">
											<i class="glyphicon glyphicon-tag"></i> <span>Billing Details</span></a>
										</li>
	<li class="<?php if($url2 == 'superadmin/image_library') echo 'active'; ?>">
											<a href="<?php echo base_url(); ?>index.php/superadmin/image_library">
											<i class="glyphicon glyphicon-tag"></i> <span>Image Library</span></a>
										</li>
										<li class="<?php if($url2 == 'superadmin/app_slider') echo 'active'; ?>">
											<a href="<?php echo base_url(); ?>index.php/superadmin/app_slider">
											<i class="glyphicon glyphicon-tag"></i> <span>App Slider</span></a>
										</li>
										...
										<li>
											<a href=""><i class= "icon-user"></i> <span>Terms & Conditions</span></a>
											<ul>
												<li class="<?php if($url2 == 'superadmin/terms_conditions/user') echo 'active'; ?>">
													<a href="<?php echo base_url(); ?>index.php/superadmin/terms_conditions/user">
													<i class="icon-envelope"></i> <span>User</span></a>
												</li>

												<li class="<?php if($url2 == 'superadmin/terms_conditions/admin') echo 'active'; ?>">
													<a href="<?php echo base_url(); ?>index.php/superadmin/terms_conditions/admin">
													<i class="icon-envelope"></i> <span>Admin</span></a>
												</li>

											</ul>
										</li>

<!-- <li class="<?php if($url2 == 'superadmin/terms_conditions') echo 'active'; ?>">
											<a href="<?php echo base_url(); ?>index.php/superadmin/terms_conditions">
											<i class="glyphicon glyphicon-tag"></i> <span>Terms & Conditions</span></a>
										</li> -->
