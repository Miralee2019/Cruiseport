...
<html lang="en">
                                        ...
                                        <div class="" style="margin-top: -40px;">
                                            ...
                                            <h2 class="text-center" style="margin-left: -10px;font-size: 30px;font-weight: 700;">
                                               ...
                                               /* $m = 0;
                                                ...
                                                ?>
                                                    <?php
                                        if (!empty($total_Walkins)) {
                                            echo count($total_Walkins);
                                        } else {
                                            echo "0";
                                        }
                                        ?>
                                            ...
                                            <h2 class="text-center" style="margin-left: 20px;font-size: 30px;font-weight: 700;"><?php
                                              /*  $sum = 0;
                                                ...
                                                if (!empty($sum)) {
                                                 ...
                                                 $point = $this->Adminmodel->select_data('T_SocialSharePoint', array('store_id' => $this->session->userdata('store_id')));
                                                    $point1 = $this->Adminmodel->select_data('T_Userstorewalkinpoint', array('store_id' => $this->session->userdata('store_id')));
                                                    //print_r($point1);
            if(!empty($point))
            {
                $social=0;
 ...
 /*         $point = $this->Adminmodel->select_data('T_UserPoint', array('user_id' => $key->user_id,'store'=>$this->session->userdata('store_id')));
            if(!empty($point))
            {
                $sum=$point[0]->facebook_points+$point[0]->walking_points+$point[0]->twitter_points;
            }else{
                $sum=0;
            }
                       echo $sum;  */
