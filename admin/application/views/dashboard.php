                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        ...
                                        <div class='portlet-body ' style="padding-top: 48px;">
                                            <div class='user-border text-center' style="margin: 0 auto !important;"><span class='user-count'><?php
                                            if(!empty($totalUsers))
                                               { 
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class='caption'>
                                            ...
                                            <div class="portlet-body" style="height: 84vh; ">
                                                                ...
                                                                <div class="col-md-12" style="margin-top: 15px;">
                                                                    ...
                                                                    <div class="col-md-10" style="margin-left: -20px;">
                                                                        ...
                                                                        <p> 
                                                                            ...
                                                                            $datetime1 = new DateTime($key->activity_date.' '.$key->activity_time);
