                                ...
                                <div class="page-header-content">
                                    <div class="page-title">
                                        ...
                                        <ul class="breadcrumb position-right">
                                            ...
                                            <li class="active">Request Points</li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <form action="<?php echo base_url(); ?>index.php/control/payment" method="post" >
                                           <!--  <div class="form-group">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <button type="submit" id="savepayment" class="btn btn-primary btn-labeled btn-labeled ml-10"><b><i class="icon-plus3"></i></b>Request</button>
