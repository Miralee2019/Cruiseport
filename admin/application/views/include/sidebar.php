...
<div class="sidebar sidebar-main">
					<div class="sidebar-content">
						...
						<div class="sidebar-user">
							<div class="category-content content-category">
								...
								<!-- <?php if($dash[0]->store_logo) { ?> -->
									...
									<!-- <p class="chk_point" style="float:left;margin-left:24px;font-size: 124px;"><b><?php echo $walk_p[0]->walking_point; ?></b>
									</p>  
									 --><br>

									<a href="#" class="media-left">

									<h1 class="hide_when_toggle" style="color: white;margin-left: 55px;padding-right: 3px;padding-top: 17px;margin-top:-3px !important;text-align: center;border-style: solid;border-radius: 100%;width: 110px;height: 110px;font-size: 45px;">
										<?php echo $dash[0]->walking_point; ?>
									</h1>	

									<h1 class="show_when_toggle" style="color: white;margin-left: 10px;text-align: center;width: 20px;height: 20px;font-size: 25px;">
										<?php //echo $dash[0]->walking_point; ?>
									</h1>	
									
									<!-- <input src="" style="max-width: 80%;"  class="img-circle img-responsive store-logo" alt="" type="image"> -->
									...
									<input src="<?php echo base_url(); ?>uploads/<?php echo $dash[0]->store_logo; ?>" style="max-width: 80%;"  class="img-circle img-responsive store-logo" alt="" type="image">


									</a>
									 -->
									<!-- <a href="#" class="media-left"> <h1 style="font-size: 70px;margin-left: 60px;" ><?php echo $walk_p[0]->walking_point; ?></h1> </a> -->
								...
								<div class="media">
									<div class="media-body text-center">
										...
										<span class="media-heading text-semibold" style="font-size: 17px;margin-left: 17px !important;">Walkin Points </span>
						...
						<div class="sidebar-category sidebar-category-visible">
									...
									<?php 	/*	<li class="<?php if($url2 == 'control/addOffer') echo 'active'; ?>">
											...
											<li class="<?php if($url2 == 'control/viewOffer') echo 'active'; ?>"><a href="<?php echo base_url();  ?>index.php/control/viewOffer"><i class="icon-eye8"></i>All Offers</a></li>
										    ...
										    <li class="<?php if($url2 == 'control/viewBeacon') echo 'active'; ?>">
												...
												<ul>
													<li class="<?php if($url2 == 'control/viewBeacon') echo 'active'; ?>"><a href="<?php echo base_url(); ?>index.php/control/addBeacons"> <i class=" icon-feed"></i>All Beacons</a></li>
											...
											<li class="<?php if($url2 == 'control/Reports') echo 'active'; ?>">
												...
												<ul>
													...
													<li class="<?php if($url2 == 'control/userReport') echo 'active'; ?>"><a href="<?php echo base_url();  ?>index.php/control/userReport"><i class="icon-users"></i>User Report</a>
													</li>
												</ul>
											</li>
											...
											<li class="<?php if($url2 == 'control/notification') echo 'active'; ?>"><a href="<?php echo base_url(); ?>index.php/control/notification"><i class="fa fa-bell-o"></i> <span>Beacon Message</span></a></li>

											<li class="<?php if($url2 == 'control/billing') echo 'active'; ?>"><a href="<?php echo base_url(); ?>index.php/control/billing"><i class="fa fa-bell-o"></i> <span>Billing</span></a></li>
...
<script type="text/javascript">
	...
	$(".second_jus").hide();
	$(".show_when_toggle").hide();

	
	$(".first_jus").click(function(){
		$(".second_jus").show();
		$(".first_jus").hide();
		$(".show_when_toggle").show();
		$(".hide_when_toggle").hide();
	});

	$(".second_jus").click(function(){
		$(".second_jus").hide();
		$(".first_jus").show();
		$(".show_when_toggle").hide();
		$(".hide_when_toggle").show();
	});
