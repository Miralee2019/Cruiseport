					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown dropdown-user">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								...
								<li><a href="<?php echo base_url(); ?>index.php/control/change_password"><i class=" icon-user-plus"></i> Change Password</a></li>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="text-align: center;">
          ...
          <p>
          	...
          	<button  class="btn btn-info" style="border-radius:0px !important;margin-left: 1px !important; background-color: #01a8f6!important;" data-dismiss="modal" >No</button>
