...
class Control extends CI_Controller {
    ...
    function home() {
        ...
        $data['store_activity'] = $this->Adminmodel->getTotalOfferActivity($this->session->userdata('store_id'));
             ...
             //   $email_user = $this->Adminmodel->select_data('T_User', array('email' => $this->input->post('email')));
                if ($data['store']) {
                    ...
                    if (!empty($data['store_old'][0]->store_email)) {
                        ...
                        $to_email = "testing.linosys@gmail.com";
...
function userReport() {
    ...
    if ($this->uri->segment(3)) {
        ...
        $data['total_Walkins'] = $this->Adminmodel->totalWalkins($login_store_id);
...
// New method 12 july
    ...
    public function send_notification() {
        ...
        $subject = "Notification from store : $storeName";
