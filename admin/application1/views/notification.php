                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="panel panel-flat">
                                        <div class="panel-heading">
                                            <h6 class="panel-title"><i class="fa fa-bell-o"></i> <b>Send Notification</b></h6>
                                            <div class="heading-elements">
                                                <ul class="icons-list">
                                    ...
                                    <div class="panel-body" style="margin-left: 11px;">
                                        ...
                                        <button id="sendnot" type="submit" class="btn bg-blue btn-labeled btn-labeled-left ml-10 "><b><i class="icon-check"></i></b> Send</button>
