                                    ...
                                    <div class="col-md-7" style="padding: 0;">
                                        <?php foreach ($userDetail as $upvalue) { ?>
                                            <div class="col-md-2" style="padding: 0;">
                                                ...
                                                <!-- <img class="img-circle" src='http://139.59.18.176/api/uploads/<?php
                                                if (isset($upvalue->profile_image)) {
                                                    echo $upvalue->profile_image;
                                                } else {
                                                    echo "user_img.png";
...
//$v=0; foreach($totlwakinuser as $twalkin) { $count[$v]=$twalkin->detected_date; $v++; } echo count($count); 
                                                ?></h2>
                                    ...
                                    <div class="col-md-9 col-xs-6">
                                        ...
                                        <div class="" style="margin-top: -40px;">
                                            ...
                                            <h2 class="text-center" style="margin-left: -10px;font-size: 30px;font-weight: 700;"><?php
                                                ...
                                                //if($total_time_spent[0]->time){ echo round($total_time_spent[0]->time)." Min"; } else { echo "0"; }  
                                                ?></h2>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($userWalkinData as $key) {
                                            ...
                                            <tr>
                                                ...
                                                $detectedtime = $this->Adminmodel->select_data('T_BeaconActivity', array('user_id' => $key->user_id, 'store_id' => $key->store_id));
                                                // echo"<pre>";
                                                // print_r($detectedtime);
                                                // echo"</pre>";
                                                // die();
                                                $storeoffername = $this->Adminmodel->select_data('T_StoreOffer', array('store_id' => $key->store_id, 'store_offer_id' => $key->store_offer_id));
                                                $total_spend_time_of_user = $this->Adminmodel->totalTimeSpentOfUser($dash[0]->store_id, $key->user_id);
                                                //print_r($total_spend_time_of_user); die();
                                                ...
                                                $point = $this->Adminmodel->select_data('T_SocialSharePoint', array('user_id' => $key->user_id, 'store_id' => $key->store_id));
                                                // echo "<pre>";
                                                // print_r($point);
                                                // echo "</pre>";
                                                // die();
                                                ...
                                                <td class="col-md-2"> <?php echo $key->activity_date; //echo $activeType[0]->activity_date;     ?> </td>
                                                <td class="col-md-2"><?php
                                                    if ($storeoffername[0] != '') {
                                                        echo $storeoffername[0]->title;
                                                    } else {
                                                        echo "-";
                                                    } //echo $activeType[0]->activity_date;   
                                                    ?> 
                                                <!-- <td class="col-md-2"><span style="background: #01a8f6;padding: 0px 13px 2px 13px;border-radius: 4px;
                                                        color: #fff;"><?php echo $key->activity_type; ?> </span></td> -->
                                                <td class="col-md-2"><span style="background: #01a8f6;padding: 0px 13px 2px 13px;border-radius: 4px;
                                                                           color: #fff;"><?php
                                                                           if ($point[$m]->share_type == "facebook_points") {
                                                                               echo "Facebook Share";
                                                                           } elseif ($point[$m]->share_type == "twitter_points") {
                                                                               echo "Twitter Share";
                                                                           } else {
                                                                               echo "-";
                                                                           }
                                                ...
                                                <td class="col-md-2"><?php echo $point[$m]->points; //echo $key->walking_point;   ?> </td>

                                                <td class="col-md-2"> <?php
                                                    if ($detectedtime[$m]) {
                                                        echo $detectedtime[$m]->detected_time;
                                                    } else {
                                                        echo"-";
                                                    }
                                                    ?>   </td> 
