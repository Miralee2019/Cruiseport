...
.icon-object {
        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="content pb-20">
                    ...
                    <form action="<?php echo base_url(); ?>index.php/welcome/reset_password/<?php echo $id; ?>" name="form1" class="form-validate" method="post" >
                        <div class="panel panel-body login-form">
                            ...
                            <div class="form-group has-feedback has-feedback-left">
                                ...
                                <input type="password" minlength="6" maxlength="12"  class="form-control" placeholder="Password" name="password1" id="password1" value="">
                                <h7 id="'chk1" style="color: red;float: left;"></h7>
                            ...
                            <div class="form-group has-feedback has-feedback-left">
                                <input type="password" minlength="6" maxlength="12" id="password2"  class="form-control" placeholder="Confirm Password" name="password2" value="">
                                <h7 id="'chk2"  style="color: red;float: left;" ></h7>  
                            ...
                            <div class="form-group">
                                <button type="submit" id="chgPassword" class="btn btn-primary btn-block">Change your password <i class="icon-arrow-right14 position-right"></i></button>
                            </div>
                            ...
                            <a href="<?php echo base_url(); ?>index.php/control/login" class="btn sign btn-block content-group">Login</a>
    ...
    $(document).ready(function(){
        ...
        // $("#chgPassword").click(function() {
            ...
            // if($('#password1').val() == ''){
            //     $('#chk1').html("Password field is required");
            //     return false;
            // } else {
            //     $('#chk1').html("");
            // }
            ...
            // if($('#password2').val() == ''){
            //     $('#chk2').html("Confirm Password field is required");
            //     return false;
            // } else {
            //     $('#chk1').html("");
            // }
