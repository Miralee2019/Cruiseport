                ...
                <div class="page-header">
                    <div class="page-header-content">
                        <div class="page-title">
                            <h4><span class="text-semibold">Paytm redemption requests</span></h4>
                        ...
                        <ul class="breadcrumb position-left">
                            ...
                            <li><a href="">Paytm redemption requests</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="content">
                ...
                <div id="hidemenow">
                    ...
                    if ($this->session->flashdata()) {
                        echo $this->session->flashdata('paytm_redeemption_status');
                    }
                    ...
                    if ($this->session->flashdata()) {
                        echo $this->session->flashdata('refresh_message7');
                    }
                    ?>
                ...
                <div class="panel panel-flat" style="overflow-x:auto;">
                    <div class="panel-heading">
                        <h6 class="panel-title"><b>Paytm redemption details</b></h6>
                        <div class="heading-elements">
                            <ul class="icons-list">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class = "dropdown-menu left" role = "menu">
                                                <!-- <li><a href = "#   "> <i class="icon-envelope"></i>  Send Email</a></li> -->
                                                   ...
                                                   <!--  <li><a href="" id="notify_user" data-user="<?php echo $key->user_id ?>" data-toggle="modal" data-target="#redeemption_modal"> <i class="icon-envelope"></i>  Send Email </a></li>
                                                   -->
                                                   <!-- <li><a id="delete-sub"><i class="icon-cross"></i> Block User </a></li> -->
                                                   
                                                   <?php if($key->request_status == 2) { ?>

                                                   <li><a href="#" id="notify_user" data-user = <?php echo $key->user_id;?> data-rubs = <?php echo $key->no_of_rubs; ?>  data-request = <?php echo $key->id; ?>  data-status = "10" data-toggle="modal" data-target="#redeemption_modal"><i class="icon-check"></i> Accept </a></li>
                                                   <li>

                                                    <li><a href="#" id="notify_user" data-user = <?php echo $key->user_id;?> data-rubs = <?php echo $key->no_of_rubs; ?>  data-request = <?php echo $key->id; ?> data-status = "8"  data-toggle="modal" data-target="#redeemption_modal"><i class="icon-cross"></i> Reject </a></li>
                                                    <li>
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-body">
                  ...
                  <form action="<?php echo base_url(); ?>index.php/superadmin/changePaytmRedeemptionStatus" method="post" class="form-horizontal"  role="form">
                    <!-- <input type="hidden" name="userId" id="userId"> -->
                    <div>
                        <label> Subject </label>
                        <input type="text"  id="sub_text" class="form-control input-lg" class="form-control" name="subject" placeholder="Enter subject">   
                    </div>
                    <br>
...
<script>
    ...
    $('<label/>').text('Custom Search: ').appendTo('#add')
     ...
     $select = $(''+
        ...
        '<form action="<?php echo base_url(); ?>/index.php/superadmin/dateRangePaytm">'+
    ...
    <script type="text/javascript">
        ...
        //     $.post("<?php echo base_url(); ?>index.php/superadmin/changePaytmRedeemptionStatus/"+user+"/"+status+"/"+request+"/"+rubs+"/", function(data, status){
        //         console.log(status);
        //         location.reload();
        //     });
        // });

       // Request accept and reject send notification upload file on 26022018
       $(document).on("click", "#notify_user", function () {
        ...
        if(status == 10) {
            ...
            sub_text="Accept user paytm redemption request";
            btn_text = "Accept And Send  Notification ";
            changemsg="Your paytm redemption request accepted successfully";
        }
        else {

            sub_text="Reject user paytm redemption request";   
            btn_text = "Reject And Send Notification";
            changemsg="Your paytm redemption request rejected successfully";   
        }
           // alert("--->"+sub_text) ;    
           
           $(".modal-body #user_id").val( user );
           $(".modal-body #status").val( status );
           $(".modal-body #request").val( request );
       ...
       $('#shows').click(function() {
        ...
        window.location.href = "<?php echo base_url(); ?>index.php/superadmin/paytmRedeemRequests/chk";
