...
<body>
													...
													<div class="form-group">
														<div class="row">
															<div class="col-md-12">
																...
																<!-- <input type="text" minlength="1" maxlength="3" value="<?php echo $walk_p[0]->walking_point; ?>" name="walk"  class="form-control"> --><input type="text" id="payment_point" onkeypress="return isNumberKey(event)"  class="form-control" maxlength="4" name="walk" value="<?php echo $walk_p[0]->walking_point; ?>">
											...
											<div class="panel-heading">
												...
												<div class="heading-elements">
													<div class="heading-btn-group">
														...
														border-radius: 4px !important;'><b><i class=" icon-cash"></i></b> Buy Points </a> 
    ...
    $("#savepayment").click(function () {
    	...
    	if (point == '') {
    		...
    		document.getElementById("point_error").innerHTML = 'Walkin Points should be greater than or equal to 10';
    		return false;
    	} else if (point % 2 != 0) {
