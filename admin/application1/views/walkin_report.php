                                    ...
                                    <tbody>
                                        <?php foreach ($userWalkinData as $key) { ?>
                                            <tr>
                                                ...
                                                <td class="col-md-2">
                                                    <div align="center">
                                                        <a href="" class="btn btn-info" style="font-size: 15px;border-radius:5px !important;" id="click" data-email="<?= $key->email; ?>" data-id="<?= $key->user_id; ?>" data-toggle="modal" data-target="#myModal">Send Notification</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php } ?>
