											...
											<div class="form-group">
												<div class="row">
													<div class="form-group">
														...
														<div class="col-md-10" >
														<input type="text" class="form-control" id="beacon_uuid" name="beacon_uuid" placeholder="UUID" maxlength="50" value="<?php echo $edit_beacon[0]->beacon_uuid; ?>">
												...
												<div class="row">
													...
													<div class="col-md-2">
														<label class="control-label" style="font-size: 14px;">  Major </label>
                                                         ...
                                                         <div class="col-md-10" >
															<input type="text" class="form-control" id="beacon_major" name="beacon_major" onkeypress="return isNumber(event)" placeholder="Major" maxlength="10" value="<?php echo $edit_beacon[0]->beacon_major; ?>">
											...
											<div class="form-group">
												<div class="row">
													...
													<label class="control-label" style="font-size: 14px;"> Minor</label>
													 ...
													 <div class="col-md-10">
														<input type="text" class="form-control" id="beacon_minor" name="beacon_minor" onkeypress="return isNumber(event)" placeholder="Minor" maxlength="10" value="<?php echo $edit_beacon[0]->beacon_minor; ?>" >
