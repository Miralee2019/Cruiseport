       ...
       /*     .navbar-nav {
                            ...
                            <div class="content">
                                ...
                                if ($space_detail) {
                                    ...
                                    <div class="text-center">
                                        ...
                                        $is_entrance_beacon = array_column_manual($beaconsdata, 'is_entrance_beacon');
                                        ?>
                                        <button type="submit" id="space_point" style="display: none;" space_id="<?= $space_detail->space_id; ?>" class="btn bg-blue btn-labeled heading-btn">Save Changes <i class="icon-arrow-right14 position-right"></i></button> 
                                        <a href="<?php echo base_url('index.php/control/assign_beacon_edit/'.$space_detail->space_id); ?>" class="btn bg-blue btn-labeled heading-btn" style="<?php if($get_placed_beacons[0]->beac_count < 1){ ?>display:none;<?php }?>">Change Beacon Position <i class="icon-arrow-right14 position-right"></i></a>
                                        <!-- < ?php if(in_array('1', $is_entrance_beacon)) { ?>
                                        < ?php } else { ?>
                                        <h3 id="show_the_alert" style="color: red;">Please add atleast one entrance beacon.</h3>
                                        < ?php } ?> -->
                                        <!-- =========================Yashraj code close ===================--> 
                                    </div>
                                </div>
        ...
        <script>
            ...
            $('#space_point').on('click', function () {
                   ...
                   /* $.ajax({
                        type: "POST",
                        url: "<?php echo site_url('control/save_beacon'); ?>",
                        ...
                        success: function (data) { 
                                ...
                                if (data = true) { 
                                    //location.reload(); 
                                    // window.location = "<?php //echo site_url()."index.php/control/assign_beacon_edit/$space_detail->space_id?> "; 
                                    // alert("asdsd"); 
