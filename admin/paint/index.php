...
<head>
  ...
  <!-- filestart -->
  <link rel="icon" type="image/vnd.microsoft.icon"  href="<?php echo base_url(); ?>paint/demo/img/favicon.ico" />
  <link rel="Stylesheet" type="text/css" href="<?php echo base_url(); ?>paint/demo/demo.css" />
  <script type="text/javascript" src="<?php echo base_url(); ?>paint/lib/jquery.1.10.2.min.js"></script>
  <!-- fileend -->
</head>
<body>
  <!-- headstart -->
  ...
  <div id="content">
    ...
    <div class="content-box">
      ...
      <div id="wPaint" style="position:relative; width:600px; height:450px; background-color:#7a7a7a; margin:70px auto 20px auto;"></div>
    ...
    <!--   <center style="margin-bottom: 50px;">
      ...
      <script type="text/javascript">
        ...
        function saveImg(image) {
          ...
          $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>paint/test/upload.php',
            data: {image: image},
