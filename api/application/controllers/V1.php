...
define("upload_url", "http://cashrub.in/cashrub/admin/");
// define("upload_url", "http://localhost/cashrub/admin/", true);
...
class V1 extends REST_Controller
{
    ...
    */
    ...
    {
        $image = base64_decode($this->input->post("brand_logo"));
        ...
        $data_insert = array('brand_logo' => $filename,
                             'brand_name' => $brand_name);

        $insert_res = $this->Apimodel->insert('t_brand', $data_insert);

        if($insert_res){
            $b = "Brand data Insert Successfully..";
        }
        else
        {
    ...
    public function brand_get()
    {
        ...
        $brand = $this->Apimodel->getbrandData($brand_id);
    ...
    public function store_get()
    {
        ...
        $store = $this->Apimodel->getStoreData($store_id);
        ...
        if (!$key) {
            ...
            if ($chk_if_store_is > 0) {
                ...
                $post_arr5 = array(
                    ...
                    "brand_category" => $chk_if_store_is[0]->brand_category ?: '',
